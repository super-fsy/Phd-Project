...
# data_path=root_path+'/Dataset/Kitti/training/disparities/' #velodyne点云转换的视差图
# data_path=root_path+'/Dataset/Kitti/training/disparities/'
# data_path=root_path+'/Dataset/Kitti/training/disparity_psmnet/'
# data_path=root_path+'/Dataset/Kitti/training/depth_map/'
# data_path=root_path+'/Dataset/Kitti/training/predict_velodyne_926/'
# data_path=root_path+'/Dataset/Kitti/training/depth-map_921/'
# data_path=root_path+'/Dataset/Kitti/training/predict_disparity/'
# data_path=root_path+'/Dataset/Kitti/training/predict_disparity_finetune300_selftrain/' #视差图效果欠佳
data_path=root_path+'/Dataset/Kitti/training/predict_disparity_finetune300_self_train/' #视差图效果较好
...
save_path=root_path+'/Dataset/KITTI/predicted_disparity/training/' #可选路径参数testing和training
disparity_number=0
